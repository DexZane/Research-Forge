...
3. `RECONCILE`: deduplicate paper families/evidence and open/resolve contradictions.
...
7. `COMMIT`: atomically replace affected registries/state or use journaled ordered writes.
