...
2. Instantiate `project-bootstrap.yaml` and required directories/registries, including research-question, fit, opportunity-signal, literature-triage, capability profile, implementation-leverage, paper bibliography fields, and the `exports/references.bib`/`exports/reading-queue.md` artifact paths.
