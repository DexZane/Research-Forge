...
- `TRUST_UNVERIFIED` cannot be finalized or executed; `TRUST_BLOCKED` cannot be selected. A dependency scan records coverage/findings, never a blanket safety claim.
